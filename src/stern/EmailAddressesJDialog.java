...
class EmailAddressesJDialog extends JDialog
			...
			WindowListener
{
			...
			ArrayList<String> emailAdressen)
	{
		...
		this.emailAddresses = emailAdressen;
	...
	private void refreshListModel()
	{
		...
		this.seq = Utils.sortList(adressenUnsorted, false);
		
		for (int i = 0; i < this.emailAddresses.size(); i++)
			model.addElement(this.emailAddresses.get(this.seq[i]));
